  ...
  "US Housing Market Outlook": {
    ...
    detail: {
      sections: [
        ...
        {
          heading: "The policy response",
          body: "Congress passed the bipartisan 21st Century ROAD to Housing Act in July, aimed at reducing housing costs and increasing supply. J.P. Morgan frames it as potential relief for buyers, though the structural shortage took a decade-plus to build and will not unwind quickly.",
        },
      ],
      figures: [
        { v: "$440,600", l: "Median US home price, all-time high" },
        { v: "36 mo", l: "Consecutive months of price increases" },
        { v: "35%", l: "Cost-to-income ratio to buy" },
  ...
  "Working Capital Strategies": {
    ...
    detail: {
      sections: [
        ...
        {
          heading: "From peripheral vendors to essential enablers",
          body: "The build-out is transforming industrial suppliers from peripheral vendors into essential enablers of the AI economy, and shifting bargaining power along the way. Cash conversion cycles are lengthening across the supply chain even as reported growth accelerates, widening the disconnect between the income statement and available liquidity.",
        },
        {
